...
<script type="text/javascript">
	function reloadcode() {
		...
		verify.setAttribute("src", "${pageContext.request.contextPath}/getVerifyCodeImg?it=" + Math.random());
	}
</script>
					...
					<div>
						...
						<form class="form-horizontal" id="form2" action="${pageContext.request.contextPath}/loginConfirm" method="post">
							...
							<div class="form-group">
								...
								<img src="${pageContext.request.contextPath}/getVerifyCodeImg" id="code" onclick="reloadcode()"
