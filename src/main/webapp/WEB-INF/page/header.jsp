...
<div class="row">
    <div class="col-md-4" role="navigation">
        ...
        <ul class="nav nav-pills">
            ...
            <li><a href="${pageContext.request.contextPath}/registerView">注册</a></li>
        </ul>
    </div>
    <div class="col-md-8">
    ...
    <nav class="navbar navbar-default" id="header-nav-middle">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="${pageContext.request.contextPath}/"><!-- <img alt="Brand" style="display: inline-block;" src="./image/tao.jpg" width="20" height="20"> --><span class="logo-word">淘身边</span></a>
            </div>
            ...
            <div class="collapse navbar-collapse"
                ...
                <ul class="nav navbar-nav">
                    <li><a class="a-color" href="${pageContext.request.contextPath}/">首页</a></li>
